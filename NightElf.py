...
NightElf = getResponse.json()['response']

for NightElf in NightElf:
    mac = NightElf['macAddress']
    serial = NightElf['serialNumber']
    mgmtIP = NightElf['managementIpAddress']
    print("The Device Mac Address is " + str(mac) + " with Serial Number " + str(serial) + " at IP " + str(mgmtIP))
